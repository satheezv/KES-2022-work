...
jnt4.PositionLimits=[-2.79253,2.79253]
...
for idx = 1:numel(trajTimes)
    ...
    angles_joint1(idx)=config(1).JointPosition
    angles_joint2(idx)=config(2).JointPosition
    angles_joint3(idx)=config(3).JointPosition
    angles_joint4(idx)=config(4).JointPosition
    angles_joint5(idx)=config(5).JointPosition
    angles_joint6(idx)=config(6).JointPosition
    ikInitGuess = config;
